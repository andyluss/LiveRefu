...
### 新增
- 新增两组**可视化页面**（离线自包含 HTML，无外部依赖，脚本已过语法检查）：叙事侧 [`故事/小说_节点之海/viz/`](doc/refu-game-001/故事/小说_节点之海/viz/README.md) 四张（人物关系图、时间线关系演化、从族功能链路、阵营对抗），策划侧 [`doc/refu-game-001/可视化/`](doc/refu-game-001/可视化/README.md) 七张（难度与胜率曲线、PMOD 增益、对空 9 宫格、空地混编、挑战卡与掉落系数、敌人数值与能量节奏、卡牌体系总览）；主卷 README 增第 31 条入口，小说 README 与人物术语对照卡同步加入口。
